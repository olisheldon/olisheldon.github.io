...
description: Sets <br/> <br/> <br/> Difficulty ★
layout: nested
---
...
[**my solution**](https://github.com/olisheldon/AdventOfCode23/blob/main/python/days/day4.py)

## Description

This problem mimics checking winning scratchcards for winning numbers. Our input is a number of scratchcards, each of which has its own winning numbers.

## Part 1

The number of winning numbers per scratchcard is the intersection of the sets of scratch card numbers and winning numbers. This is easily done by the Python set data structure. Each scratch card scores `2**(N - 1)` points, where N is the number of winning scratchcard numbers on the scratchcard. We must return the sum of all scratch cards scores.
...
The idea of scratch cards being worth is points is discarded. Instead, the number of winning numbers on each card wins you one copy of the next cards. 
