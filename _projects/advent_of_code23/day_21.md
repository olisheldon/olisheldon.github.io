...
In this problem we are given a map of a garden containing garden plots, rocks, and a starting position (that is a garden plot). Each step from the starting position can be in any of the cardinal directions onto adjacency garden plots.

## Part 1

Starting from the starting position, count the number of tiles it is possible to be standing on after taking 64 steps.
