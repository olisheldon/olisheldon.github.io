...
As of Python 3.10, the worst case performance was improved to O(N + M). [Two-way string-matching algorithm](https://en.wikipedia.org/wiki/Two-way_string-matching_algorithm).
